...
extension JournalEntryQuerySortBy
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByLatitude() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'latitude', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByLatitudeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'latitude', Sort.desc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByLongitude() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'longitude', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByLongitudeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension JournalEntryQuerySortThenBy
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByLatitude() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'latitude', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByLatitudeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'latitude', Sort.desc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByLongitude() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'longitude', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByLongitudeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'longitude', Sort.desc);
    });
  }
...
extension JournalEntryQueryWhereDistinct
  ...
  QueryBuilder<JournalEntry, JournalEntry, QDistinct> distinctByLatitude() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'latitude');
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QDistinct> distinctByLongitude() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'longitude');
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QDistinct> distinctByMediaPaths() {
    return QueryBuilder.apply(this, (query) {
...
extension JournalEntryQueryProperty
  ...
  QueryBuilder<JournalEntry, double?, QQueryOperations> latitudeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'latitude');
    });
  }

  QueryBuilder<JournalEntry, double?, QQueryOperations> longitudeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JournalEntry, Mood, QQueryOperations> moodProperty() {
    return QueryBuilder.apply(this, (query) {
